...
To run the fat jar:
    ...
    java -jar target/servestr-3.0.0-SNAPSHOT-fat.jar
...
java -jar build/libs/servestr-3.0.0-SNAPSHOT-fat.jar -instances 8

You can also enable clustering and ha at the command line, e.g.

java -jar build/libs/servestr-3.0.0-SNAPSHOT-fat.jar -cluster

java -jar build/libs/servestr-3.0.0-SNAPSHOT-fat.jar -ha
