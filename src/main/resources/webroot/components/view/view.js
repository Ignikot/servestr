...
angular.module('servestrApp.view', [
    'ngRoute',
    'ui.grid',
    'ui.grid.cellNav',
    'ui.grid.edit',
    ...
    .controller('viewCtrl', ['$scope', '$filter', '$http', 'vertxEventBusService', 'uiGridConstants', 'servestrConfig', 'toaster', function ($scope, $filter, $http, vertxEventBusService, uiGridConstants, servestrConfig, toaster) {
        $scope.collection = 'services';
